    ...
    '>
         ...
         <div className='flex items-center gap-6 relative '>
            <div className='relative '>
                ...
                className='absolute right-[-85px] mt-4 w-64 
                rounded-2xl  
                bg-black/90 backdrop-blur-xl
                border border-white/10  
                shadow-[0_25px_60px__rgba(0,0,0,0.7)] 
                p-4 text-white'>
            ...
            <div className='relative '>
                ...
                whileTap={{scale:0.97}}
                 className=' flex items-center gap-2 
                px-4 py-2 rounded-full bg-white/10 
                border border-white/20 w-11 h-11 
                text-white text-sm  
                shadow-md cursor-pointer'>
                ...
                p-4 text-white'>
                    ...
                    <MenuItem text='Logout' red onClick={() =>{
...
function MenuItem({onClick, text , red}){
    return(
        <div 
        onClick={onClick} className={`w-full text-left px-5 py-3 text-sm transition-color 
            rounded-lg
        ${
            red
