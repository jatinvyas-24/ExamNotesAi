...
function Footer() {
  ...
  return (
    ...
    className=' z-10 mx-6 mt-24 mb-6 
    rounded-2xl
    ...
    >
        <div className=' grid grid-cols-1 md:grid-cols-3 gap-8 items-center' >
            ...
            style={{ transformStyle: "preserve-3d"  }}>
                ...
                <span className='text-lg font-semibold bg-gradient-to-br from-white via-gray-300 to-white
            ...
            <div className='text-center'>
                ...
                <ul className='space-y-2 text-sm cursor-pointer'>
                    ...
                    <li onClick={()=> handleSignOut()} className='text-gray-300 hover:text-white transition-colors' > SignOut</li>
