  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-gray-100 to-gray-200 px-6 py-8'>
      ...
      <motion.div className='mb-12'>
        <Topic loading={loading} setResult={setResult} setError={setError} setLoading={setLoading} />
      ...
      {!result && <motion.div
      whileHover={{scale: 1.02}} className=' h-64 rounded-2xl flex flex-col items-center justify-center bg-white/60 backdrop-blur-lg
      ...
      animate ={{ opacity:1 , y:0}}
      transition={{duration:0.4}} className=' flex flex-col lg:grid lg:grid-cols-4 gap-6'>
